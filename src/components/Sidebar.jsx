...
const Sidebar = () => {
  ...
  const normalLink = `flex items-center gap-5 pl-4 pt-4 pb-2.5 rounded-lg text-white text-md 
  text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2`

  return (
    <div className="mk-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10">
      {activeMenu && (<>
        <div className="flex justify-between items-center">
          ...
          <TooltipComponent content="Menu" position="BottomCenter">
            <button typd="button" onClick = {() => {}} className="text-xl rounded-full p-3 hover:bg-light-gray mt-4 black md:hiden">
